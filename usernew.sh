...
echo Script Autocreacion de Cuenta SSH y OpenVPN de PT. Inovasi Bakti Nusantara
sleep 1
echo Ping Host
echo Cek Hak Akses...
sleep 0.5
...
echo -e ""
echo -e "Gracias por usar nuestros servicios"
echo -e "Información de la cuenta SSH y OpenVPN"
...
echo -e "Script by PT. Inovasi Bakti Nusantara"
